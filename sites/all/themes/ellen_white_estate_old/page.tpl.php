...
<div id="header">
    ...
    <div id="header-inside">
        ...
        <div id="header-inside-left">
            ...
            <?php if ($logo): ?>
            <a id="logo" href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
            <?php endif; ?>
...
<div id="header-menu-inside">
	...
	<div class="account_controls">
    	<?php print render($page['account_controls']); ?>    
    </div>	
...
<div id="content">
    ...
    <div id="content-inside" class="inside">
        ...
        <?php if (drupal_is_front_page()):
        	...
        	if ($page['home_left']): ?>
      			<div class="home_left one_third">
        			<?php print render($page['home_left']); ?>
     			 </div>
   			 <?php endif; ?>
             
        	<?php if ($page['home_middle']): ?>
      			<div class="home_middle one_third">
        			<?php print render($page['home_middle']); ?>
     			 </div>
   			 <?php endif; ?>

        	<?php if ($page['home_right']): ?>
      			<div class="home_right one_third">
