    ...
    Drupal.behaviors.facetapiDateRange = {
        attach: function (context, settings) {
            ...
            $.each(forms, function (formId, formIdProperties) {
                ...
                var flagID = formIdProperties.flagID;
                var statusSwitcherID = formIdProperties.statusSwitcherID;
                var statusLabelID = formIdProperties.statusLabelID;

                var onStatusLabel = formIdProperties.onStatusLabel;
                var offStatusLabel = formIdProperties.offStatusLabel;
                var switcherLabelOn = formIdProperties.switcherLabelOn;
                var switcherLabelOff = formIdProperties.switcherLabelOff;
                ...
                //Handler for changing status of filter
                $( "#" + statusSwitcherID ).click(function (event) {
                    var currentStatus = $ ( "#" + flagID ).val();
                    if(currentStatus == '1'){
                        $( "#" + flagID ).val('');
                        $( "#" + statusLabelID ).html(offStatusLabel);
                        $( "#" + statusSwitcherID).val(switcherLabelOn);
                    }else{
                        $( "#" + flagID ).val('1');
                        $( "#" + statusLabelID ).html(onStatusLabel);
                        $( "#" + statusSwitcherID).val(switcherLabelOff);
                    }
                    return false;
                });
