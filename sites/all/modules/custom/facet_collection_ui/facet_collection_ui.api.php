...
/**
 * @file
 * Provides API documentation for adding  new field type support at facet_collection_ui module
 *
 * Module facet_collection_ui allows to add new type of field for filtering.
 * To do this, you need to create new submodule with
 * such name  - facet_collection_ui_*machine name of new type that you need to add*.
 ...
 * what submodule(facet_collection_ui_*machine name of new type that you need to add*) in what needed.
 *
 */
